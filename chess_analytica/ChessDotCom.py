...
class Profile :
    ...
    def __init__(self, username: str, save_mode: bool = False) :
        ...
        if (save_mode) :
            ...
            self.__current_games_data = self.retrieve_current_games() #contains current game data, scraped directly from chess.com API
            self.__games_data = self.retrieve_player_games() #contains all archived game data, scraped directly from chess.com API
